export default function MailPreviewModal({ mail, onClose }) {
  if (!mail) return null;
      ...
      >
          ...
          <div>
            <h2
              className={`text-xl font-semibold ${
                mail.status === "success" ? "text-emerald-400" : "text-red-400"
              }`}
            >
              {mail.title}
            </h2>
        ...
        <div
          className="bg-gray-950 border border-gray-800 rounded-xl p-5
                        text-sm text-gray-300 font-mono whitespace-pre-line"
        >
          {mail.content}
        </div>
