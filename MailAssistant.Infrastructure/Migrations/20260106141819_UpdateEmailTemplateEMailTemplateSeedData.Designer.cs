...
namespace MailAssistant.Infrastructure.Migrations
{
    ...
    [Migration("20260106141819_UpdateEmailTemplateEMailTemplateSeedData")]
    partial class UpdateEmailTemplateEMailTemplateSeedData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MailAssistant.Domain.Entities.EmailTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e8c34623-ab86-48f7-827e-3d80f0711d0b"),
                            ...
                            CreatedAt = new DateTime(2026, 1, 6, 14, 18, 18, 714, DateTimeKind.Utc).AddTicks(1650),
                            Title = "İş Başvurusu"
                        },
                        new
                        {
                            Id = new Guid("0c849438-6d9b-42a6-af46-0c5bfc93a5b4"),
                            ...
                            CategoryId = new Guid("11111111-1111-1111-1111-111111111111"),
                            CreatedAt = new DateTime(2026, 1, 6, 14, 18, 18, 714, DateTimeKind.Utc).AddTicks(1655),
                            Title = "Staj Başvurusu"
                        },
                        new
                        {
                            Id = new Guid("62f74ab4-bf66-4d40-adc2-61f8ad7a66a5"),
                            ...
                            CreatedAt = new DateTime(2026, 1, 6, 14, 18, 18, 714, DateTimeKind.Utc).AddTicks(1657),
                            Title = "Toplantı Talebi"
                        },
                        new
                        {
                            Id = new Guid("7594719d-9552-4532-8a27-23c83af0b470"),
                            Body = "Merhaba {{RecipientName}},\n\n{{OriginalDate}} tarihinde planlanan toplantı ertelenmiştir.\nYeni tarih ayrıca paylaşılacaktır.\n\nBilginize sunarım.\n\n{{Signature}}",
                            CategoryId = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2026, 1, 6, 14, 18, 18, 714, DateTimeKind.Utc).AddTicks(1659),
                            Title = "Toplantı Erteleme Bilgilendirmesi"
                        },
                        new
                        {
                            Id = new Guid("bc87dee3-2169-41b8-94ba-ad43ee304014"),
                            ...
                            CreatedAt = new DateTime(2026, 1, 6, 14, 18, 18, 714, DateTimeKind.Utc).AddTicks(1714),
                            Title = "Teknik Destek Talebi "
                        },
                        new
                        {
                            Id = new Guid("4463fc99-6998-40da-aee5-1fc941ae38f4"),
                            Body = "Merhaba {{RecipientName}},\n\n{{SystemName}} için {{RequestedPermission}} yetkisine ihtiyacım bulunmaktadır.\n\nGereğini rica ederim.\n\n{{Signature}}",
                            CategoryId = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2026, 1, 6, 14, 18, 18, 714, DateTimeKind.Utc).AddTicks(1716),
                            Title = "Erişim Yetkisi Talebi"
                        },
                        new
                        {
                            Id = new Guid("c36581cb-19db-48fe-becb-7cac89e001b4"),
                            ...
                            CreatedAt = new DateTime(2026, 1, 6, 14, 18, 18, 714, DateTimeKind.Utc).AddTicks(1718),
                            Title = "İş Birliği Teklifi"
                        },
                        new
                        {
                            Id = new Guid("93ea04b9-1dff-407d-b21a-05ca062d201c"),
                            Body = "Merhaba {{RecipientName}},\n\n{{ServiceName}} hizmetiniz için fiyat ve kapsam bilgisi içeren\nteklifinizi tarafımıza iletmenizi rica ederiz.\n\nİyi çalışmalar,\n{{Signature}}",
                            CategoryId = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTime(2026, 1, 6, 14, 18, 18, 714, DateTimeKind.Utc).AddTicks(1720),
                            Title = "Teklif Talebi"
                        },
                        new
                        {
                            Id = new Guid("02ae4e56-7f89-4bae-adcf-9b2ed889b2f3"),
                            ...
                            CreatedAt = new DateTime(2026, 1, 6, 14, 18, 18, 714, DateTimeKind.Utc).AddTicks(1724),
                            Title = "Görev Ataması"
                        },
                        new
                        {
                            Id = new Guid("059a2bd5-434b-4557-8c69-2f2a3845095a"),
                            Body = "Merhaba {{RecipientName}},\n\n{{ProjectName}} projesine ait güncel durum aşağıdaki gibidir:\n\n{{StatusSummary}}\n\nBilginize sunarım.\n\n{{Signature}}",
                            CategoryId = new Guid("55555555-5555-5555-5555-555555555555"),
                            CreatedAt = new DateTime(2026, 1, 6, 14, 18, 18, 714, DateTimeKind.Utc).AddTicks(1726),
                            Title = "Durum Güncellemesi"
                        },
                        new
                        {
                            Id = new Guid("f0db027d-a8f3-4d25-a644-0d1f26598c0d"),
                            ...
                            CreatedAt = new DateTime(2026, 1, 6, 14, 18, 18, 714, DateTimeKind.Utc).AddTicks(1728),
                            Title = "Maaş Düzenlenmesi Görüşme Talebi"
                        },
                        new
                        {
                            Id = new Guid("554bbd37-01bc-4b97-9ff9-222624e866fe"),
                            Body = "Merhaba {{RecipientName}},\n\n{{InvoiceNumber}} numaralı faturaya ait ödemenin\ntarafımıza iletilmesini rica ederiz.\n\nBilgilerinize sunarız.\n\n{{Signature}}",
                            CategoryId = new Guid("66666666-6666-6666-6666-666666666666"),
                            CreatedAt = new DateTime(2026, 1, 6, 14, 18, 18, 714, DateTimeKind.Utc).AddTicks(1730),
                            Title = "Ödeme Talebi"
                        });
                });
