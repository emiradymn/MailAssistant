...
namespace MailAssistant.Infrastructure.Migrations
{
    ...
    [Migration("20260113140807_AddSentMailsPropSingature")]
    partial class AddSentMailsPropSingature
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MailAssistant.Domain.Entities.EmailTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0cd1ae79-1977-4ab0-8b94-581f6ab5a93a"),
                            ...
                            CreatedAt = new DateTime(2026, 1, 13, 14, 8, 7, 190, DateTimeKind.Utc).AddTicks(8659),
                            Title = "İş Başvurusu"
                        },
                        new
                        {
                            Id = new Guid("1e8aac36-3837-445b-a340-c70868ce2cd3"),
                            ...
                            CategoryId = new Guid("11111111-1111-1111-1111-111111111111"),
                            CreatedAt = new DateTime(2026, 1, 13, 14, 8, 7, 190, DateTimeKind.Utc).AddTicks(8684),
                            Title = "Staj Başvurusu"
                        },
                        new
                        {
                            Id = new Guid("7e6fdf89-1f19-4234-a7a7-559494caf044"),
                            ...
                            CreatedAt = new DateTime(2026, 1, 13, 14, 8, 7, 190, DateTimeKind.Utc).AddTicks(8686),
                            Title = "Toplantı Talebi"
                        },
                        new
                        {
                            Id = new Guid("b9c29357-3538-4f80-8e89-128be7f1935c"),
                            Body = "Merhaba {{RecipientName}},\n\n{{OriginalDate}} tarihinde planlanan toplantı ertelenmiştir.\nYeni tarih ayrıca paylaşılacaktır.\n\nBilginize sunarım.\n\n{{Signature}}",
                            CategoryId = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2026, 1, 13, 14, 8, 7, 190, DateTimeKind.Utc).AddTicks(8688),
                            Title = "Toplantı Erteleme Bilgilendirmesi"
                        },
                        new
                        {
                            Id = new Guid("a77d40ba-5c02-46aa-b446-74d780ced0d1"),
                            ...
                            CreatedAt = new DateTime(2026, 1, 13, 14, 8, 7, 190, DateTimeKind.Utc).AddTicks(8690),
                            Title = "Teknik Destek Talebi "
                        },
                        new
                        {
                            Id = new Guid("8dbfbe1b-9929-4863-81a7-d380b7d13398"),
                            Body = "Merhaba {{RecipientName}},\n\n{{SystemName}} için {{RequestedPermission}} yetkisine ihtiyacım bulunmaktadır.\n\nGereğini rica ederim.\n\n{{Signature}}",
                            CategoryId = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2026, 1, 13, 14, 8, 7, 190, DateTimeKind.Utc).AddTicks(8691),
                            Title = "Erişim Yetkisi Talebi"
                        },
                        new
                        {
                            Id = new Guid("ddba7528-ceda-44d7-94c1-28010ea8ac84"),
                            ...
                            CreatedAt = new DateTime(2026, 1, 13, 14, 8, 7, 190, DateTimeKind.Utc).AddTicks(8693),
                            Title = "İş Birliği Teklifi"
                        },
                        new
                        {
                            Id = new Guid("7dad2fc5-337f-49c7-9802-6ec00c123189"),
                            Body = "Merhaba {{RecipientName}},\n\n{{ServiceName}} hizmetiniz için fiyat ve kapsam bilgisi içeren\nteklifinizi tarafımıza iletmenizi rica ederiz.\n\nİyi çalışmalar,\n{{Signature}}",
                            CategoryId = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTime(2026, 1, 13, 14, 8, 7, 190, DateTimeKind.Utc).AddTicks(8695),
                            Title = "Teklif Talebi"
                        },
                        new
                        {
                            Id = new Guid("2c97783a-e9af-461f-a770-ebaaa30ee7f8"),
                            ...
                            CreatedAt = new DateTime(2026, 1, 13, 14, 8, 7, 190, DateTimeKind.Utc).AddTicks(8697),
                            Title = "Görev Ataması"
                        },
                        new
                        {
                            Id = new Guid("c2078de1-92f6-41b1-aa1e-e3534196915b"),
                            Body = "Merhaba {{RecipientName}},\n\n{{ProjectName}} projesine ait güncel durum aşağıdaki gibidir:\n\n{{StatusSummary}}\n\nBilginize sunarım.\n\n{{Signature}}",
                            CategoryId = new Guid("55555555-5555-5555-5555-555555555555"),
                            CreatedAt = new DateTime(2026, 1, 13, 14, 8, 7, 190, DateTimeKind.Utc).AddTicks(8701),
                            Title = "Durum Güncellemesi"
                        },
                        new
                        {
                            Id = new Guid("234c722c-d717-4d42-ba70-f3692841b121"),
                            ...
                            CreatedAt = new DateTime(2026, 1, 13, 14, 8, 7, 190, DateTimeKind.Utc).AddTicks(8703),
                            Title = "Maaş Düzenlenmesi Görüşme Talebi"
                        },
                        new
                        {
                            Id = new Guid("c63d1ef0-c5c2-4da5-92db-019deada6dc7"),
                            Body = "Merhaba {{RecipientName}},\n\n{{InvoiceNumber}} numaralı faturaya ait ödemenin\ntarafımıza iletilmesini rica ederiz.\n\nBilgilerinize sunarız.\n\n{{Signature}}",
                            CategoryId = new Guid("66666666-6666-6666-6666-666666666666"),
                            CreatedAt = new DateTime(2026, 1, 13, 14, 8, 7, 190, DateTimeKind.Utc).AddTicks(8705),
                            Title = "Ödeme Talebi"
                        });
                });
